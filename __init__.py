...
class Generate_GQ:
    def __init__(self, context, output_directory, scene):
        ...
        max_gq = np.unravel_index(np.argmax(gq), gq.shape)
        print(f'X: {points_3d_world[max_gq[0], max_gq[1], 0]}')
        print(f'Y: {points_3d_world[max_gq[0], max_gq[1], 1]}')
        print(f'Z: {points_3d_world[max_gq[0], max_gq[1], 2]}')
        print(f'VX: {vector_array[max_gq[0], max_gq[1], 0]}')
        print(f'VY: {vector_array[max_gq[0], max_gq[1], 1]}')
        print(f'VZ: {vector_array[max_gq[0], max_gq[1], 2]}')
        
        array_no_nans = np.nan_to_num(points_3d_world[:,:,0], nan=0)
        np.savetxt("C:/Users/andre/Desktop/Scene/x.csv", array_no_nans, delimiter=',', fmt='%f')
        
        array_no_nans = np.nan_to_num(points_3d_world[:,:,1], nan=0)
        np.savetxt("C:/Users/andre/Desktop/Scene/y.csv", array_no_nans, delimiter=',', fmt='%f')
        
        array_no_nans = np.nan_to_num(points_3d_world[:,:,2], nan=0)
        np.savetxt("C:/Users/andre/Desktop/Scene/z.csv", array_no_nans, delimiter=',', fmt='%f')
        
        array_no_nans = np.nan_to_num(gq, nan=0)
        np.savetxt("C:/Users/andre/Desktop/Scene/gq.csv", array_no_nans, delimiter=',', fmt='%f')
        
        array_no_nans = np.nan_to_num(vector_array[:,:, 0], nan=0)
        np.savetxt("C:/Users/andre/Desktop/Scene/Vx.csv", array_no_nans, delimiter=',', fmt='%f')
        
        array_no_nans = np.nan_to_num(vector_array[:,:, 1], nan=0)
        np.savetxt("C:/Users/andre/Desktop/Scene/Vy.csv", array_no_nans, delimiter=',', fmt='%f')
        
        array_no_nans = np.nan_to_num(vector_array[:,:, 2], nan=0)
        np.savetxt("C:/Users/andre/Desktop/Scene/Vz.csv", array_no_nans, delimiter=',', fmt='%f')
        
        #array_no_nans = np.nan_to_num(distance, nan=0)
        #np.savetxt("C:/Users/andre/Desktop/distance.csv", array_no_nans, delimiter=',', fmt='%f')
        
        #array_no_nans = np.nan_to_num(height, nan=0)
        #np.savetxt("C:/Users/andre/Desktop/height.csv", array_no_nans, delimiter=',', fmt='%f')
        
        #array_no_nans = np.nan_to_num(flatness, nan=0)
        #np.savetxt("C:/Users/andre/Desktop/flat.csv", array_no_nans, delimiter=',', fmt='%f')
        
        #array_no_nans = np.nan_to_num(smoothness, nan=0)
        #np.savetxt("C:/Users/andre/Desktop/smooth.csv", array_no_nans, delimiter=',', fmt='%f')
        
        #array_no_nans = np.nan_to_num(impacts, nan=0)
        #np.savetxt("C:/Users/andre/Desktop/impacts.csv", array_no_nans, delimiter=',', fmt='%f')
        
        #array_no_nans = np.nan_to_num(edge, nan=0)
        #p.savetxt("C:/Users/andre/Desktop/edge.csv", array_no_nans, delimiter=',', fmt='%f')
...
def register():
    ...
    bpy.types.Scene.output_directory = bpy.props.StringProperty(
        ...
        default="C:/Users/andre/Documents/Bases de Datos/Experimento 1/"
    )
